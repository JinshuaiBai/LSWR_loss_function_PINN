"""
    ...
    plate. We take the top-right quarter of the plate for the modeling. The sample points are 
    uniformly distributed in the computational domain with 0.2 m intervals in all directions. We
...
if __name__ == '__main__':
    ...
    net_u = Net(n_input = 2, n_output = 1, layers=[20, 20, 20, 20, 20])
    net_v = Net(n_input = 2, n_output = 1, layers=[20, 20, 20, 20, 20])
