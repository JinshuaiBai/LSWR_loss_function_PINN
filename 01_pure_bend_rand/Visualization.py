...
def Vis(E, pinn, net1, net2, xy, T, L, it):
    ...
    fig1 = plt.figure(1)
    plt.scatter(xy[:,0], xy[:,1], s = 10, c = u, cmap = 'jet', vmin=-0.0228, vmax=0.0228)
    plt.axis('equal')
    plt.colorbar()
    plt.title('u')
    ...
    fig2 = plt.figure(2)
    plt.scatter(xy[:,0], xy[:,1], s = 10, c = v, cmap = 'jet', vmin=-0.1138, vmax=0)
    plt.axis('equal')
    plt.colorbar()
    plt.title('v')
    ...
    fig3 = plt.figure(3)
    plt.scatter(xy[:,0], xy[:,1], s = 10, c = s11, cmap = 'jet', vmin=-50, vmax=50)
    plt.axis('equal')
    plt.colorbar()
    ...
    fig4 = plt.figure(4)
    plt.scatter(xy[:,0], xy[:,1], s = 10, c = s22, cmap = 'jet', vmin=-2, vmax=2)
    plt.axis('equal')
    plt.colorbar()
    ...
    fig5 = plt.figure(5)
    plt.scatter(xy[:,0], xy[:,1], s = 10, c = s12, cmap = 'jet', vmin=-2, vmax=2)
    plt.axis('equal')
    plt.colorbar()
    plt.title(r'$\tau_{xy}$')
