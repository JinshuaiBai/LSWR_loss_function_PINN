"""
    ...
    This code is for the pure bending beam problem in "A New Way to Formulate the Loss Function in 
    ...
    randomly distributed in the computational domain. The Delaunay segementation from the Scipy 
    library is adopted to integral the residuals in the computational domain. We use two FNNs with 
    the same structures to respectively predict the displacement field u and v. The Young's module 
    E = 1000 Pa and the Poisson ratio is 0.3.
...
if __name__ == '__main__':
    ...
    """
        ...
        Calculate the Si for numerical integration.
        
    """
    
    ar = Tri_Segm(x_train[0], ns)
    ...
    l_bfgs_b = Opt_lbfgsb(pinn, x_train, y_train, dx, h, ar)
